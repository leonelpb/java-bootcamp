...
--
-- Host: 127.0.0.1    Database: ropa_db
-- ------------------------------------------------------
...
DROP TABLE IF EXISTS `tbl_prenda`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
LOCK TABLES `tbl_prenda` WRITE;
/*!40000 ALTER TABLE `tbl_prenda` DISABLE KEYS */;
INSERT INTO `tbl_prenda` VALUES (1,'Rojo',25.45,'M');
/*!40000 ALTER TABLE `tbl_prenda` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-09-15 15:18:34
